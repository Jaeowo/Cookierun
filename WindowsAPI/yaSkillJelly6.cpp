...
namespace ya
{
	SkillJelly6::SkillJelly6()
		:mSpeed(-300.0f)
	{
		if (mImage == nullptr)
		{
			mImage = Resources::Load<Image>(L"SkillJ6", L"..\\Resources\\Image\\Jelly\\Lilly\\SkillJ6.bmp");
		}
	...
	void SkillJelly6::Render(HDC hdc)
	{
		Vector2 pos = GetPos();
	...
	void SkillJelly6::OnCollisionEnter(Collider* other)
	{
