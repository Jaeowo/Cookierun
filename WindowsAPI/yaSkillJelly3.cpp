...
namespace ya
{
	SkillJelly3::SkillJelly3()
		:mSpeed(-300.0f)
	{
		if (mImage == nullptr)
		{
			mImage = Resources::Load<Image>(L"SkillJ3", L"..\\Resources\\Image\\Jelly\\Lilly\\SkillJ3.bmp");
		}
	...
	void SkillJelly3::Render(HDC hdc)
	{
		Vector2 pos = GetPos();
	...
	void SkillJelly3::OnCollisionEnter(Collider* other)
	{
